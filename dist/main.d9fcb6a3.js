...
var hashMap = xObject || [{ logo: 'x', url: 'https://www.xiedaimala.com' }];
var removeX = function removeX(url) {
    return url.replace('https://', '').replace('http://', '').replace('www.', '').replace(/\/.*/, ''); //删除./开头的内容直到结尾，这是正则表达式
};
...
//# sourceMappingURL=/main.d9fcb6a3.map